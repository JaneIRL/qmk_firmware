...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_QWERTY] = LAYOUT(QK_GESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_PSCR, KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSLS, KC_LSFT, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_LCTL, LCTL_T(KC_Z), LSFT_T(KC_X), LGUI_T(KC_C), LALT_T(KC_V), KC_B, TG(1), MO(3), KC_N, RALT_T(KC_M), RGUI_T(KC_COMM), RSFT_T(KC_DOT), RCTL_T(KC_SLSH), KC_ENT, KC_SPC, KC_SPC, MO(2), MO(2), KC_BSPC, KC_DEL),
	...
	[_MISC] = LAYOUT(KC_F12, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_TRNS, BL_INC, BL_TOGG, RGB_SAI, RGB_TOG, RGB_MOD, KC_TRNS, KC_MSTP, KC_VOLU, KC_MPLY, KC_BRIU, KC_TRNS, KC_TRNS, BL_DEC, RGB_HUD, RGB_SAD, RGB_HUI, RGB_RMOD, KC_TRNS, KC_MPRV, KC_VOLD, KC_MNXT, KC_BRID, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MUTE, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS)
};
